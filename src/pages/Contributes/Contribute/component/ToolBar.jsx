    ...
    render () {
        ...
        return (
            <div className={style.pageHd}>
                <Link to={`/contribute/index/add`}>
                    <Button onClick={this.handleSearch} type="default">投稿</Button>
                </Link>
                ...
                <Button type={status === '4' ? 'primary' : 'default'} onClick={() => this.handleNavBtnOnClick('4')}>回收站</Button>
                <Input
